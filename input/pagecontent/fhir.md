...
<table class="grid">
  ...
  <tbody>
    ...
    <tr><td><a href="{{site.data.fhir.path}}measure.html">Measure</a></td><td></td>Used to represent a VBP contract. Also used in example quality measure reports for measures.</td></tr>    
    ...
    <tr><td><a href="{{site.data.fhir.path}}group.html">Group</a></td><td>Used to represent the MeasureReport subject being a group.</td></a></td></tr>        
