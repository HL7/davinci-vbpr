§This implementation guide **SHALL** meet the requirements defined in the [Security and Privacy](https://hl7.org/fhir/us/davinci-hrex/STU1.1/security.html) section of the [Da Vinci Health Record Exchange (HRex)](https://hl7.org/fhir/us/davinci-hrex/STU1.1/index.html).§

§Implementers **SHALL** read and adhere to the guidance for the following topics:§
